    ...
    <main className="min-h-screen">
      ...
      <section className="pt-32 pb-24 bg-white">
        <div className="max-w-[800px] mx-auto px-6 lg:px-10">
          <div className="mb-12">
            <h1 className="font-sora text-4xl md:text-5xl font-bold text-gray-900 mb-4">Privacy Policy</h1>
            <p className="text-gray-500">Last updated: March 2026</p>
          </div>

          <div className="prose prose-gray max-w-none space-y-8">
            <div>
              <h2 className="font-sora text-2xl font-bold text-gray-900 mb-4">1. Information We Collect</h2>
            ...
            <div>
              <h2 className="font-sora text-2xl font-bold text-gray-900 mb-4">2. How We Use Your Information</h2>
            ...
            <div>
              <h2 className="font-sora text-2xl font-bold text-gray-900 mb-4">3. Information Sharing</h2>
            ...
            <div>
              <h2 className="font-sora text-2xl font-bold text-gray-900 mb-4">4. Data Security</h2>
            ...
            <div>
              <h2 className="font-sora text-2xl font-bold text-gray-900 mb-4">5. Cookies</h2>
            ...
            <div>
              <h2 className="font-sora text-2xl font-bold text-gray-900 mb-4">6. Your Rights</h2>
              <p className="text-gray-600 leading-relaxed">Under Australian Privacy Principles, you have the right to access, correct, or request deletion of your personal information. To exercise these rights, please contact us at harj@thedesignhomes.com.au.</p>
            </div>

            <div>
              <h2 className="font-sora text-2xl font-bold text-gray-900 mb-4">7. Contact Us</h2>
